...
def validate_data(df, nombre_archivo):
    ...
    # Validación de Negocio y Rangos
    ...
    if 'ventas' in nombre:
        ...
        if col_id and col_fecha and col_cant:
            ...
            # Combinamos: ID no nulo Y Cantidad OK Y Fecha OK
    ...
    # Se guardan los registros rechazados por validación de negocio/rangos
